...
const USERS = {
  ...
  store_manager: {
    ...
    permissions: ['home', 'house', 'house:rent', 'house:sale', 'house:reserve_house', 'house:customer', 'house:community', 'finance', 'finance:bill', 'finance:flow', 'finance:arrears', 'finance:plan', 'finance:payout'],
  },
  salesman: {
    id: 4, name: '李业务员', mobile: 'salesman', avatar: '',
    role: 'salesman', roleName: '业务员', dataScope: 'self',
    storeIds: [1], groupIds: [1], assignedStoreIds: [],
    permissions: ['home', 'house', 'house:rent', 'house:sale', 'house:reserve_house', 'house:reserve_client', 'house:customer', 'house:community'],
  },
  finance: {
    id: 5, name: '赵财务', mobile: 'finance', avatar: '',
    role: 'finance_manager', roleName: '财务负责人', dataScope: 'company',
    storeIds: [1,2,3], groupIds: [1,2], assignedStoreIds: [],
    permissions: ['home', 'finance', 'finance:bill', 'finance:flow', 'finance:arrears', 'finance:plan', 'finance:payout'],
  },
  housekeeper: {
    id: 6, name: '周管家', mobile: 'housekeeper', avatar: '',
    role: 'housekeeper', roleName: '管家', dataScope: 'group',
    storeIds: [1], groupIds: [1], assignedStoreIds: [],
    permissions: ['home', 'house', 'house:rent', 'house:reserve_house', 'house:customer'],
  },
};
...
// ============================================================
const RENTAL_SETS = [
  { id: 1, code: 'ZJ001', bizType: 'entire', communityId: 1, communityName: '张江汤臣豪园', address: '浦东新区张江路688号', building: '12', unit: '1', roomNo: '802', layout: '两室一厅', buildingArea: 85, decoration: 'fine', landlordRent: 4500, rent: 6200, deposit: 6200, leaseStart: '2026-01-15', leaseEnd: '2027-01-14', status: 'rented', storeId: 1, groupId: 1, landlordId: 1, salesmanId: 4, housekeeperId: 15, roomCount: 0, vacantCount: 0, createdAt: '2026-01-10', rooms: [] },
  { id: 2, code: 'ZJ002', bizType: 'shared', communityId: 1, communityName: '张江汤臣豪园', address: '浦东新区张江路688号', building: '8', unit: '2', roomNo: '501', layout: '四室一厅', buildingArea: 135, decoration: 'fine', landlordRent: 6800, rent: 8800, deposit: 4400, leaseStart: '2026-02-01', leaseEnd: '2027-01-31', status: 'rented', storeId: 1, groupId: 1, landlordId: 2, salesmanId: 4, housekeeperId: 15, roomCount: 4, vacantCount: 0, createdAt: '2026-01-20',
    rooms: [
      { id: 101, setId: 2, roomNo: 'A', roomType: '主卧', rentPrice: 2800, listedPrice: 3000, status: 'rented', leaseEnd: '2026-12-31', paymentMethod: 'quarterly', depositAmount: 2800, tenantName: '刘洋', tenantPhone: '13900000001' },
      { id: 102, setId: 2, roomNo: 'B', roomType: '次卧', rentPrice: 2200, listedPrice: 2400, status: 'rented', leaseEnd: '2026-11-30', paymentMethod: 'quarterly', depositAmount: 2200, tenantName: '陈静', tenantPhone: '13900000002' },
      { id: 103, setId: 2, roomNo: 'C', roomType: '次卧', rentPrice: 2000, listedPrice: 2200, status: 'rented', leaseEnd: '2027-01-15', paymentMethod: 'monthly', depositAmount: 2000, tenantName: '赵磊', tenantPhone: '13900000003' },
  ...
  { id: 3, code: 'ZJ003', bizType: 'shared', communityId: 2, communityName: '张江家园', address: '浦东新区张江路128号', building: '5', unit: '1', roomNo: '302', layout: '三室一厅', buildingArea: 98, decoration: 'simple', landlordRent: 3500, rent: 5400, deposit: 2700, leaseStart: '2026-03-01', leaseEnd: '2027-02-28', status: 'rented', storeId: 1, groupId: 1, landlordId: 3, salesmanId: 6, housekeeperId: 15, roomCount: 3, vacantCount: 1, createdAt: '2026-02-15',
    rooms: [
      { id: 105, setId: 3, roomNo: 'A', roomType: '主卧', rentPrice: 2200, listedPrice: 2400, status: 'rented', leaseEnd: '2026-10-31', paymentMethod: 'quarterly', depositAmount: 2200, tenantName: '孙悦', tenantPhone: '13900000004' },
      { id: 106, setId: 3, roomNo: 'B', roomType: '次卧', rentPrice: 1800, listedPrice: 2000, status: 'rented', leaseEnd: '2027-01-31', paymentMethod: 'monthly', depositAmount: 1800, tenantName: '周涛', tenantPhone: '13900000005' },
  ...
  { id: 4, code: 'ZJ004', bizType: 'entire', communityId: 3, communityName: '城市经典花园', address: '浦东新区张江镇高科中路', building: '3', unit: '2', roomNo: '1501', layout: '三室两厅', buildingArea: 120, decoration: 'luxury', landlordRent: 6000, rent: 8500, deposit: 8500, leaseStart: '2026-04-01', leaseEnd: '2027-03-31', status: 'rented', storeId: 1, groupId: 1, landlordId: 4, salesmanId: 4, housekeeperId: 15, roomCount: 0, vacantCount: 0, createdAt: '2026-03-15', rooms: [] },
  { id: 5, code: 'ZJ005', bizType: 'shared', communityId: 4, communityName: '联洋年华', address: '浦东新区联洋路168号', building: '9', unit: '1', roomNo: '601', layout: '四室两厅', buildingArea: 145, decoration: 'fine', landlordRent: 7500, rent: 9600, deposit: 4800, leaseStart: '2026-03-15', leaseEnd: '2027-03-14', status: 'rented', storeId: 2, groupId: 3, landlordId: 5, salesmanId: 7, housekeeperId: null, roomCount: 4, vacantCount: 1, createdAt: '2026-03-01',
    rooms: [
      { id: 108, setId: 5, roomNo: 'A', roomType: '主卧独卫', rentPrice: 3200, listedPrice: 3500, status: 'rented', leaseEnd: '2026-12-31', paymentMethod: 'quarterly', depositAmount: 3200, tenantName: '吴杰', tenantPhone: '13900000006' },
      { id: 109, setId: 5, roomNo: 'B', roomType: '次卧', rentPrice: 2400, listedPrice: 2600, status: 'rented', leaseEnd: '2026-11-30', paymentMethod: 'quarterly', depositAmount: 2400, tenantName: '钱峰', tenantPhone: '13900000007' },
      { id: 110, setId: 5, roomNo: 'C', roomType: '书房', rentPrice: 2000, listedPrice: 2200, status: 'rented', leaseEnd: '2026-10-15', paymentMethod: 'monthly', depositAmount: 2000, tenantName: '许晴', tenantPhone: '13900000008' },
...
// ============================================================
const PROFITS = [
  { id: 1, period: '2026-06', income: 186500, cost: 82300, profit: 104200, margin: 55.9 },
  { id: 2, period: '2026-07', income: 198200, cost: 85600, profit: 112600, margin: 56.8 },
  { id: 3, period: '2026-08', income: 216800, cost: 89200, profit: 127600, margin: 58.9 },
];
const INCOME_COSTS = [
  { id: 1, period: '2026-06', rentIncome: 145000, depositIncome: 28000, energyIncome: 8500, otherIncome: 5000, rentCost: 62000, energyCost: 8500, decorateCost: 6000, laborCost: 4800, otherCost: 1000, totalIncome: 186500, totalCost: 82300 },
  { id: 2, period: '2026-07', rentIncome: 152000, depositIncome: 32000, energyIncome: 9200, otherIncome: 5000, rentCost: 64000, energyCost: 9200, decorateCost: 7000, laborCost: 4800, otherCost: 600, totalIncome: 198200, totalCost: 85600 },
  { id: 3, period: '2026-08', rentIncome: 168000, depositIncome: 35000, energyIncome: 9800, otherIncome: 4000, rentCost: 68000, energyCost: 9800, decorateCost: 5000, laborCost: 5400, otherCost: 1000, totalIncome: 216800, totalCost: 89200 },
];
const PERFORMANCES = [
...
const ACCOUNTINGS = [
  { id: 1, period: '2026-06', revenue: 186500, receivable: 28000, payable: 15000, actualIncome: 158500, actualExpense: 82300, diff: 76200 },
  { id: 2, period: '2026-07', revenue: 198200, receivable: 32000, payable: 18600, actualIncome: 166200, actualExpense: 85600, diff: 80600 },
  { id: 3, period: '2026-08', revenue: 216800, receivable: 35000, payable: 22000, actualIncome: 181800, actualExpense: 89200, diff: 92600 },
];
const PARTNERS = [
...
const PORT = 3000;
app.listen(PORT, () => {
  console.log(`Mock server running on http://localhost:${PORT}/api`);
