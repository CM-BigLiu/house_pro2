  ...
  <div class="form-page">
    ...
    <div class="card" v-loading="loading" style="padding: 24px;">
      <el-form :model="form" label-width="100px">
        ...
        <el-row :gutter="16"><el-col :span="12"><el-form-item label="金额" required><PlainNumberInput v-model="form.amount" :min="0" :precision="2" style="width: 100%;" /><MoneyUppercase :value="form.amount" /></el-form-item></el-col><el-col :span="12"><el-form-item label="逾期费"><PlainNumberInput v-model="form.overdueFee" :min="0" :precision="2" style="width: 100%;" /><MoneyUppercase :value="form.overdueFee" /></el-form-item></el-col></el-row>
