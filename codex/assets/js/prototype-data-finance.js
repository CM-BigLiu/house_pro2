Object.assign(window.PROTOTYPE_PAGES, {
  ...
  flow: {
    ...
    typeTabs: [{ label: '汇总' }, { label: '明细' }],
    statusTabs: [{ label: '今日待出纳 5' }, { label: '未出纳 12' }, { label: '终审待审 3' }],
    filters: [
      { label: '店面', type: 'select', options: ['全部', '张江店', '浦东店'] }, { label: '业务类型', type: 'select', options: ['租房', '售房', '储备'] },
  ...
  profit: {
    ...
    layout: 'table',
    columns: [
      { label: '房源编号', key: 'code' }, { label: '店面', key: 'store' }, { label: '物业地址', key: 'house' }, { label: '管家', key: 'keeper' }, { label: '性质', key: 'nature' },
    ...
    rows: [
      { code: 'F202608001', store: '张江店', house: '汤臣豪园3-301', keeper: '王晓明', nature: '包租', subject1: '收入', subject2: '租金', reason: '租客房租', remark: '8月', createdAt: '2026-08-01', range: '08-01~08-31', amount: '¥6,800', days: 31, currentAmount: '¥6,800', operations: [{ label: '查看' }] },
      { code: 'F202608012', store: '浦东店', house: '天赋领墅2-601', keeper: '王晓明', nature: '包租', subject1: '成本', subject2: '房东租金', reason: '房东房租', remark: '8月', createdAt: '2026-08-01', range: '08-01~08-31', amount: '¥5,000', days: 31, currentAmount: '¥5,000', operations: [{ label: '查看' }] },
      { code: 'F202608018', store: '浦东店', house: '天赋领墅2-601', keeper: '王晓明', nature: '包租', subject1: '成本', subject2: '装修摊销', reason: '房间翻新', remark: '6个月摊销', createdAt: '2026-06-01', range: '06-01~11-30', amount: '¥18,000', days: 183, currentAmount: '¥3,000', operations: [{ label: '查看' }] }
    ],
  ...
  'income-cost': {
    ...
    columns: [
      ...
      { label: '上月租金收入', key: 'lastIncome' }, { label: '服务费差额', key: 'serviceDiff' }
    ],
    rows: [
      { store: '张江店', code: 'F202608001', house: '汤臣豪园3-301', biz: '租房', mode: '包租', customer: '王小明', nature: '业主合同', start: '2025-09-01', end: '2027-08-16', leave: '—', freeDays: 0, rent: '¥6,800', service: '¥200', shouldDays: 31, days: 31, lastDays: 31, dayDiff: 0, income: '¥6,800', lastIncome: '¥6,800', serviceDiff: '¥0' },
      { store: '浦东店', code: 'F202608012', house: '天赋领墅2-601', biz: '合租', mode: '包租', customer: '周女士', nature: '转租合同', start: '2025-08-16', end: '2027-03-12', leave: '—', freeDays: 5, rent: '¥2,000', service: '¥100', shouldDays: 31, days: 26, lastDays: 27, dayDiff: '-1', income: '¥1,677', lastIncome: '¥1,742', serviceDiff: '-¥17' }
    ],
  ...
  plan: {
    ...
    columns: [
      ...
      { label: '审核', key: 'audit' }, { label: '备注', key: 'remark' }, { label: '操作', key: 'operations' }
    ],
    rows: [
      { store: '张江店', type: '支出', category: '物业费', reason: '物业管理费', person: '供应商（王林）', periods: 12, interval: '1月', total: '¥24,000', finished: '¥16,000', audit: '已审核【张店长 08-01】', remark: '全年物业', operations: [{ label: '查看' }, { label: '审核', permission: 'finance:update' }] },
      { store: '浦东店', type: '收入', category: '房租或押金类收入', reason: '首次签约房租', person: '租客（周先生）', periods: 1, interval: '按期数不规则缴费', total: '¥3,100', finished: '¥3,100', audit: '待审核', remark: '一次性', operations: [{ label: '查看' }, { label: '审核', permission: 'finance:update' }] },
      { store: '联洋店', type: '支出', category: '能源费用类支出', reason: '水电气费', person: '物业（联洋物业）', periods: 4, interval: '1季度', total: '¥8,400', finished: '¥4,200', audit: '已审核', remark: '公区分摊', operations: [{ label: '查看' }] }
    ],
