...
- [x] 3.2 review agent 对 git diff feat/pg/auth-token-refresh 做静态审查
...
- [x] 4.3 启动服务（如需）
- [x] 4.4 验证 V-backend-N：来自 design.md（N 由 design.md 决定，非章节号）
...
- [x] 8.2 review agent 对 git diff feat/pg/auth-token-refresh 做静态审查
...
- [x] 9.3 启动服务（如需）
- [x] 9.4 验证 V-frontend-N：来自 design.md（N 由 design.md 决定，非章节号）
...
- [x] 13.2 review agent 对 git diff feat/pg/auth-token-refresh 做静态审查
...
- [x] 14.3 启动服务（如需）
- [x] 14.4 验证 V-backend-N：来自 design.md（N 由 design.md 决定，非章节号）
